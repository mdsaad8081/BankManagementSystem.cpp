...
int main(){
	...
	cout<<"\n\t\t-----<:: ......................... ::>------\n\t\t\t\t";
	cin>>choice;
    //Real life example of the program to used bank management system the option the common from that simple program the system of used this of power mode the system of this are often  
    switch(choice){
        case '1':
